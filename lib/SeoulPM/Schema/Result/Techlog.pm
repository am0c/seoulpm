use utf8;
package SeoulPM::Schema::Result::Techlog;
...
=head1 TABLE: C<techlog>

=cut

__PACKAGE__->table("techlog");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:t8EMAcadJkPDiW+sLA/g9Q
